      ...
      <div className="flex flex-col items-end w-1/2">
        ...
        <Link to={link}>
          <button
            ...
            className="text-white disabled:bg-primary-400 bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900"
          >
            {buttonTitle}
          </button>
        </Link>
